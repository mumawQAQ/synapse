...
The `@synapse/server` package acts as the orchestration brain. It manages the LLM loops, validates results, registers secure tool handlers, and tracks individual WebSocket connections.
