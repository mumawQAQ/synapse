...
The `@synapse/client` package provides a dead-simple React SDK that seamlessly connects to your backend `AgentServer`.
...
```tsx
import { useAgent, AGENT_EVENTS } from "@synapse/client";
